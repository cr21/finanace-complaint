from pyspark.sql.types import StringType, StructField, StructType, FloatType, TimestampType, IntegerType
...
class FinanceDataSchema:
    ...
    @property
    def skip_validation_features(self)->Set[str]:
        features = set()
        features.add(self.col_consumer_consent_provided)
        return features
